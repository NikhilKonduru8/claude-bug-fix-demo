"""
Tests for the clean version of user_service.
These all pass on the first commit, then break on the buggy commit.
"""
...
def test_get_usernames_empty():
    assert get_usernames([]) == []
